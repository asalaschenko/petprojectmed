...
func validateNewJsonDoctors(newEntry *Doctor) (bool, string) {
	flag := true
	outputString := ""
...
func validateUpdateJsonDoctors(newEntry *Doctor) (bool, string) {
	flag := true
	outputString := ""
...
func returnIndexOfTargetSpecialization(specialization string, array *[]Doctor) []int {
	outputArray := []int{}
