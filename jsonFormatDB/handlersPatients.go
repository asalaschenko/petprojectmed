...
func validateNewJsonPatients(newEntry *Patient) (bool, string) {
	flag := true
	outputString := ""
...
func validateUpdateJsonPatients(newEntry *Patient) (bool, string) {
	flag := true
	outputString := ""
	caser := cases.Lower(language.Russian)
...
func returnIndexOfTargetPhoneNumber(phone_number string, array *[]Patient) []int {
	outputArray := []int{}
