...
func CreateAppointment(c *fiber.Ctx) error {
	...
	newEntryInput := new(InputJsonAppointment)
	...
	newEntryOutput := new(Appointment)
...
func validateNewJsonAppointment(val *InputJsonAppointment) (bool, string) {
	doctors := ReadDoctorsJsonFile()
	patients := ReadPatientsJsonFile()
	flag := true
	outputString := ""
...
func returnIndexOfTargetDoctorID(ID string, array *[]Appointment) []int {
	outputArray := []int{}
...
func returnIndexOfTargetPatientID(ID string, array *[]Appointment) []int {
	outputArray := []int{}
	intID, err := strconv.Atoi(ID)
	if err == nil {
		for index, value := range *array {
...
func returnIndexOfTargetDateTime(dateTime string, array *[]Appointment) []int {
	outputArray := []int{}
